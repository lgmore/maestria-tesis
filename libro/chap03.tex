...
En éste trabajo se propone abordar el problema planteado utilizando la Metaheurística $MOPSO$ que sintoniza los parámetros de $CLAHE$. La propuesta se describe en el \textbf{Algoritmo \ref{alg:pso_clahe}}:
