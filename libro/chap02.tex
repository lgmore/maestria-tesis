...
\begin{axis}[every axis plot post/.append style={
  ...
  %\addplot {gauss(0,0.5)};
  \addplot [name path=gauss]{gauss(1,0.75)};
  \addplot[name path=line, gray, no markers, line width=1pt] {0.35};
   \addplot fill between[ 
    of = gauss and line, 
    split, % calculate segments
    every even segment/.style = {white!70},
...
\begin{axis}[every axis plot post/.append style={
  ...
  yticklabels={,,},
  xticklabels={,,},
  at={(0.66\linewidth,0)}] % extend the axes a bit to the right and top
  %\addplot {gauss(0,0.5)};
  \addplot [name path=gauss2, shift={(0,50)}]{gauss2(1,0.75)};
  \addplot[name path=line, gray, no markers, line width=1pt] {0.35};
   \addplot fill between[ 
    of = gauss2 and line, 
    split, % calculate segments
    every even segment/.style = {white!70},
    every odd segment/.style  = {green!60}
  ];
   \draw [fill=blue!40!white, thick] (axis cs:-2,-0) rectangle (axis cs:3.05,0.05);
\end{axis}
\node (A) at (3.5, 4) {};
\node (B) at (11, 0.5) {};
...
%        \label{fig:cuborgb}
% \end{subfigure}
\caption{Redistribución de niveles de intensidad dentro del histograma de una región de una imagen, como paso previo al cálculo del $CDF$. Ésto tiene como efecto la suavización del proceso de mejora del contraste.}\label{fig:redistclahe}
\end{figure}
...
\centering
    %\begin{subfigure}[t]{0.45\textwidth}
    \begin{subfigure}[]{
    \includegraphics[width=0.45\textwidth]{./Figures/cubo-rgb.jpg}
    }
%        \caption{Imagen Original. $\mathscr{H_Y}=0.207231$, $SSIM_R=1$, $SSIM_G=1$, $SSIM_B=1$}
%        \label{fig:cuborgb}
\end{subfigure}
...
%        \label{fig:cuborgb}
% \end{subfigure}
\caption{Imagen de ejemplo con las representaciones de intensidad ($Y$) y de color ($Cb,Cr$). Nótese que el mapa de intensidades $Y$ es una representación en escala de grises de la imagen digital. Imagen obtenida de \cite{pict3}.}\label{fig:ejemploycbcr}
\end{figure}
...
\centering
    %\begin{subfigure}[t]{0.45\textwidth}
    \begin{subfigure}[]{
    \includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-0.png}
    }
%        \caption{Imagen Original. $\mathscr{H_Y}=0.207231$. $SSIM_R=1$. $SSIM_G=1$. $SSIM_B=1$}
\end{subfigure}
    ~ %add desired spacing between images. e. g. ~. \quad. \qquad. \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
      \begin{subfigure}[]{
      \includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-8.png}   
      }
    %\begin{subfigure}[t]{0.45\textwidth}
%        \caption{Enhanced Image. $\mathscr{H_Y}=0.611275$. $SSIM_R=0.00897331$. $SSIM_G=0.00823064$. $SSIM_B=0.00851013$}
\end{subfigure}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[]{
    \includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-21.png}
    }
    % \begin{subfigure}[t]{0.45\textwidth}
%        \caption{Enhanced Image.  $\mathscr{H_Y}=0.0350595$. $SSIM_R=0.416776$. $SSIM_G=0.403636$. $SSIM_B=0.417654$}
\end{subfigure} 
\begin{subfigure}[]{
\includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-42.png}
}
    % \begin{subfigure}[t]{0.45\textwidth}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[]{
    \includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-75.png}
    }
    % \begin{subfigure}[t]{0.45\textwidth}
%        \caption{Enhanced Image.  $\mathscr{H_Y}=0.0350595$. $SSIM_R=0.416776$. $SSIM_G=0.403636$. $SSIM_B=0.417654$}
...
\end{subfigure} 
\begin{subfigure}[]{
\includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-79.png}
}
    % \begin{subfigure}[t]{0.45\textwidth}
        %\caption{Enhanced Image using \cite{morepso}. $\mathscr{H_Y}=0.788927$. $SSIM_R=0.000204143$. $SSIM_G=0.0000526475$. $SSIM_B=0.0000518143$}
        ...
        \end{subfigure}
\begin{subfigure}[]{
\includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-95.png}
}
    % \begin{subfigure}[t]{0.45\textwidth}
        %\caption{Enhanced Image using \cite{morepso}. $\mathscr{H_Y}=0.788927$. $SSIM_R=0.000204143$. $SSIM_G=0.0000526475$. $SSIM_B=0.0000518143$}
        \label{fig:calhouse23129}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[]{
    \includegraphics[width=0.43\textwidth]{./Figures/ejemplopso/capas-99.png}
    }
    % \begin{subfigure}[t]{0.45\textwidth}
%        \caption{Enhanced Image.  $\mathscr{H_Y}=0.0350595$. $SSIM_R=0.416776$. $SSIM_G=0.403636$. $SSIM_B=0.417654$}
\label{fig:calhouse231102}
\end{subfigure}
        \caption{Comportamiento de partículas en $PSO$ Monobjetivo a través de la serie de iteraciones. Nótese que las equis (x) indican un punto o solución potencial que se mueve sobre la superficie donde los colores más fríos son mejores soluciones.Imagen obtenida de \cite{pict4}.}
